...
parser.add_argument("--use_chat_format", type=bool,
                    default=False, help="Whether to use chat format")
...
# print(adam_optimizer_state.keys())
if args.task is not None:
    ...
    dataset = get_training_dataset(
        args.train_file, tokenizer, args.max_length, sample_percentage=1.0, start=args.start, end=args.end)
