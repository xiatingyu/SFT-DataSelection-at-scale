...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_path', type=str, default="llama3-8b-base")
    parser.add_argument('--instruction_path', type=str, default="OpenHermes2.5.json")
    parser.add_argument('--save_path', type=str, default="save/openhermes")
